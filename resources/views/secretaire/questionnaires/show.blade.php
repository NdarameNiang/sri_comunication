        ...
        @if($questionnaire->recommanderait)
            <div class="text-center">
                <div class="flex gap-0.5 justify-center">
                    @for($s = 0; $s < 5; $s++)
                        <svg class="w-4 h-4 text-indigo-400" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005z" clip-rule="evenodd"/></svg>
                    @endfor
                </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 divide-x divide-gray-100">
            ...
            <div class="py-5 px-4 text-center">
                ...
                <p class="text-3xl font-extrabold {{ $n >= 4 ? 'text-emerald-600' : ($n >= 3 ? 'text-indigo-500' : 'text-red-500') }}">
                ...
                <div class="mt-2 h-1.5 bg-gray-100 rounded-full overflow-hidden mx-2">
                    <div class="h-full rounded-full {{ $n >= 4 ? 'bg-emerald-400' : ($n >= 3 ? 'bg-indigo-400' : 'bg-red-400') }}"
