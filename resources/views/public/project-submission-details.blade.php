...
<div class="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
    ...
    <div class="px-6 pt-5">
        ...
        @if($existingUser || !empty($identity['email']) || !empty($identity['phone']))
        <div class="mt-3 flex items-start gap-2.5 bg-emerald-50 border border-emerald-200 rounded-xl p-3">
            ...
            <p class="text-xs text-emerald-800">
                Vos coordonnées connues ont été retrouvées et pré-remplies ci-dessous. Vérifiez qu'il s'agit bien de vous avant de continuer.
            </p>
        </div>
        @endif
    </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $existingUser->email ?? $identity['email'] ?? '') }}" required
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $existingUser->phone ?? $identity['phone'] ?? '') }}"
