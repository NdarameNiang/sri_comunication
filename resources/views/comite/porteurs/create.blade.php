...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('comite.porteurs.index') }}" class="btn-secondary text-xs">
                @include('components.icon', ['name' => 'arrow-left'])
                Retour
            </a>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('comite.porteurs.store') }}" class="space-y-6" id="porteurForm">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" value="{{ old('phone') }}" class="form-input" placeholder="+221 7X XXX XX XX">
                        </div>
                        <div>
                            <label class="form-label">Email (identifiant de connexion) <span class="text-red-500">*</span></label>
                ...
                <div class="flex gap-3 pt-2 border-t border-gray-100">
                    ...
                    <a href="{{ route('comite.porteurs.index') }}" class="btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
