...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'content-blocks.manage',   'label' => 'Gérer le contenu de la page publique',  'group' => 'Configuration'],
            ...
            ['name' => 'evaluation.manageRubric', 'label' => 'Configurer la grille d\'évaluation',    'group' => 'Évaluation'],
            ['name' => 'evaluation.score',        'label' => 'Évaluer des projets soumis',            'group' => 'Évaluation'],
            ['name' => 'evaluation.viewRanking',  'label' => 'Consulter le classement',               'group' => 'Évaluation'],
            ['name' => 'evaluation.finalize',     'label' => 'Finaliser le classement / quota',       'group' => 'Évaluation'],
            ['name' => 'evaluation.resolveTies',  'label' => 'Départager manuellement les ex-æquo',   'group' => 'Évaluation'],
            ['name' => 'evaluation.sendEmails',   'label' => 'Envoyer les emails de sélection',       'group' => 'Évaluation'],
            ['name' => 'inscriptions.manage',     'label' => 'Gérer les inscriptions publiques',      'group' => 'Événement public'],
            ['name' => 'inscriptions.manageAudience', 'label' => 'Définir le public autorisé à l\'inscription', 'group' => 'Événement public'],
        ...
        $roles = [
            ...
            [
                ...
                'permissions' => [
                    'events.manage', 'form-options.manage', 'content-blocks.manage',
                    'porteurs.manage', 'porteurs.credentials',
                    'projects.viewAll', 'submission-period.manage',
                    'evaluation.manageRubric', 'evaluation.viewRanking', 'evaluation.finalize',
                    'evaluation.resolveTies', 'evaluation.sendEmails',
                    'inscriptions.manageAudience',
                    'users.viewAny',
                ],
            ],
            [
